...
<div id="Team Mutiny" class="wp-block-group meet-us mb-[80px] desktop:mb-[150px] desktop:pb-0 pb-[60px]">
  ...
  <div class="wp-block-group container mx-auto relative desktop:px-0 px-[20px]">
    <!-- wp:paragraph -->
    <p>
      <svg class="shape opacity-[60%] scale-[0.6] desktop:scale-[1] z-[-1] absolute desktop:top-0 top-[-50px] desktop:right-[0px] right-[-60px]" xmlns="http://www.w3.org/2000/svg" width="470" height="395" viewBox="0 0 470 395" fill="none">
    ...
    <div class="wp-block-group cols desktop:flex">
      <!-- wp:group -->
      <div class="wp-block-group col1 relative desktop:pl-[150px] mb-[50px] desktop:w-[45%]">
        <!-- wp:paragraph -->
        <p>
          <svg class="shape opacity-[60%] absolute top-[270px] left-[30px]" xmlns="http://www.w3.org/2000/svg" width="235" height="317" viewBox="0 0 235 317" fill="none">
            ...
            <li class="wp-block-group wide:w-[400px] wide:h-[510px] tile-wrapper relative mb-[12px] rounded-[20px] overflow-hidden">
              ...
              <p>
                <svg width="0" height="0">
                  <defs>
                    <clipPath id="clipped-swiper-serv-1" class="scale-[0.49] desktop:scale-[0.839] wide:scale-[1.2]">
          ...
          <ul class="wp-block-list inner-col2 w-[49%] absolute top-[60px] right-0">
            ...
            <li class="tile-wrapper relative mb-[12px] rounded-[20px] overflow-hidden">
              ...
              <p>
                <svg width="0" height="0">
                  <defs>
                    <clipPath id="clipped-team" class="scale-[0.49] desktop:scale-[0.839] wide:scale-[1.11]">
