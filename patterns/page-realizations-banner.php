...
/**
 * Title: page-realizations-banner
 * Slug: page-realizations-banner
...
<div id="Banner" class="wp-block-group realizations-banner h-auto desktop:mb-[150px]">
  <!-- wp:group -->
      ...
      <div id="title" class="wp-block-group title-wrapper relative container mx-auto desktop:flex">
        ...
        <div class="wp-block-group section-title grid desktop:w-[145px] desktop:basis-auto uppercase text-primaryYellow">
          ...
          <div class="wp-block-group h-fit overflow-hidden flex desktop:justify-end">
            <!-- wp:heading {"level":3} -->
            <h3 class="wp-block-heading test01 justify-self-start desktop:justify-self-end pt-[7px] pr-[15px]">Realizacje</h3>
            <!-- /wp:heading -->
          </div>
          <!-- /wp:group -->
        ...
        <!-- wp:heading -->
        <h2 class="wp-block-heading uslugi-title uppercase font-medium desktop:text-[60px] text-[30px] desktop:leading-[68px] leading-[30px]"><span class="block overflow-hidden"><span class="test01 company-title block font-medium overflow-hidden"><span class="block">PROJEKTY Z KTÓRYCH</span></span></span><span class="block overflow-hidden"><span class="uppercase test01 inline-block ">JESTEŚMY<span class="relative ml-[12px] inline-block uppercase italic before:content-[''] before:inline-block desktop:before:mr-[18px] before:mr-[8px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-black">DUMNI</span></span><span class="test01 inline-block company-title font-medium"><span class="ml-[-8px] desktop:ml-[-16px] desktop:text-[100px] text-[70px] leading-[1px] desktop:leading-auto">.</span></span></span></h2>
        <!-- /wp:heading -->
