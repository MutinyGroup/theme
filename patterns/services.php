...
<div id="Usługi" class="wp-block-group uslugi desktop:mb-[150px] mb-[80px]">
  ...
  <div class="wp-block-group desktop:mb-[150px] mb-[80px] relative overflow-hidden desktop:overflow-visible">
    ...
    <div class="wp-block-group title-wrapper relative container mx-auto desktop:px-0 px-[20px] desktop:mb-[80px] mb-[50px] desktop:mt-0 flex gap-[20px]">
      ...
      <!-- /wp:group -->
      <!-- wp:paragraph -->
      <p data-aos="fade-up" class="section-title uppercase text-primaryYellow">Usługi</p>
      <!-- /wp:paragraph -->
      <!-- wp:group -->
      <div class="wp-block-group uslugi-title z-[1]">
        ...
        <div class="wp-block-group overflow-hidden">
          <!-- wp:paragraph -->
          <p data-aos="fade-up" class="uppercase inline-block desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">KAMPANIE REALIZUJEMY</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
        <!-- wp:group -->
