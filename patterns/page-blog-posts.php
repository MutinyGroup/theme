      ...
      <ul class="wp-block-list blog-posts-wrapper flex flex-wrap desktop:justify-center desktop:gap-x-[100px] wide:gap-x-[100px] gap-y-[40px] desktop:gap-y-[200px]">
        ...
        if ($post_query->have_posts()) {
          while ($post_query->have_posts()) {
            ...
            if ($tab[$i] == 0) { ?>
              <!-- wp:list-item -->
              <li class="wp-block-group bigger swiper-slide slideBlog opacity-0 relative group w-full desktop:w-[535px] wide:w-[580px] h-fit desktop:h-[545px] wide:h-[650px] <?php echo (!($counter % 2)) ? 'desktop:translate-y-[120px]' : ''; ?>">
            ...
            ?>
              <!-- wp:list-item -->
              <li class="wp-block-group smaller swiper-slide slideBlog opacity-0 relative group w-full desktop:w-[444px] wide:w-[490px] h-fit desktop:h-[500px] <?php echo (!($counter % 2)) ? 'desktop:translate-y-[120px]' : ''; ?>">
                <a href="<?php the_permalink(); ?>">
                  <!-- wp:group -->
                  <div class="wp-block-group h-full mb-[20px]">
                    <!-- wp:group -->
