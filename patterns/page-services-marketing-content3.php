  ...
  <div class="wp-block-group container mx-auto relative desktop:px-0 px-[20px]">
    ...
    <div class="wp-block-group text-cols-wrapper flex desktop:gap-[0px] gap-[20px] basis desktop:mb-[100px] mb-[50px]">
      ...
      <div class="wp-block-group col1 relative desktop:pl-[155px] basis-[40%]">
        ...
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
        <p class="max-w-[173px] text-[16px] leading-[21px] z-[1]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
      <!-- wp:group -->
      <div class="wp-block-group col2 relative basis-[60%]">
        ...
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
        <p class="desktop:text-[20px] text-[18px] desktop:leading-[30px] leading-[26px] pb-[50px] z-[1]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
        <p class="hidden desktop:block text-[16px] leading-[21px] z-[1]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
    </div>
