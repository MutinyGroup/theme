...
<ul id="Desktop" class="wp-block-list nav-desktop h-[60px] desktop:h-[90px] hidden desktop:flex justify-center items-center relative z-[3]">
  ...
  <!-- wp:list-item -->
  <li class="wp-block-group lang-btn group h-fit hidden desktop:flex flex-col p-[10px_20px] uppercase font-medium border-[2px] border-[#AAAAAA] rounded-full hover:rounded-[20px] absolute top-[20px] right-[20px] cursor-pointer hover:bg-white hover:border-white hover:text-black transition ease-out duration-300">
