      ...
      <?php
        ...
        <?php
          ...
          if (($cat->name) == 'glowna' || ($catNoSpaces) == 'bez-kategorii'){
            ...
            <!-- wp:list-item -->
            <li
              class="w-fit test2 h-[40px] px-[10px] bg-[#F2F2F2] border border-[#AAA] border-[2px] rounded-full uppercase text-[14px] font-semibold leading-[20px] flex justify-center items-center hover:bg-primaryYellow hover:border-primaryYellow transition ease-out duration-300 cursor-pointer"
            >
              <!-- wp:paragraph -->
