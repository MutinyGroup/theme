...
<div id="Usługi" class="wp-block-group uslugi desktop:mb-[150px] mb-[80px]">
  ...
  <div class="wp-block-group desktop:mb-[150px] mb-[80px] relative">
    ...
    <div class="wp-block-group mt-[80px] desktop:mt-[-120px] w-full h-[660px] wide:h-[720px] overflow-hidden">
      ...
      <!-- wp:group -->
      <div id="services" class="wp-block-group swiper swiperServices desktop:w-[calc(100%-90px)] desktop:pt-[180px] absolute top-[140px] desktop:top-[160px] left-[20px] desktop:left-[90px]">
