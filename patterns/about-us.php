    ...
    <div class="wp-block-group title-wrapper container mx-auto relative desktop:mb-[110px] mb-[80px] flex gap-[20px]">
      ...
      <div class="wp-block-group uslugi-title is-layout-flow">
        ...
        <div class="wp-block-group overflow-hidden">
          ...
          <div class="wp-block-group overflow-hidden">
            <!-- wp:paragraph -->
            <p data-aos="fade-up" data-aos-duration="600" class="uppercase inline-block desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">(v2) Holistyczne podejście do działań</p>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
          <!-- wp:group -->
          <div class="wp-block-group overflow-hidden">
            <!-- wp:paragraph -->
            <p data-aos="fade-up" data-aos-duration="600" class="uppercase inline-block desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">reklamowych sprawia, że nasza firma </p>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
          <!-- wp:group -->
