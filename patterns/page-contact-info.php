      ...
      <div class="wp-block-group col1 desktop:w-[35%]">
        ...
        >
          ...
          <svg x="0px" y="0px" viewBox="0 0 1374.7 1083.6" class="absolute top-0" >
            <defs>
              <clipPath id="clipped-blog" class="scale-[0.00199] scale-x-[0.0028] desktop:scale-y-[0.0022] desktop:scale-[0.0028] wide:scale-y-[0.0021]" clipPathUnits="objectBoundingBox">
