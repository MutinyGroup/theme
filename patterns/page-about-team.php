...
<div id="Team Mutiny" class="wp-block-group meet-us mb-[80px] desktop:mb-[150px] desktop:pb-0 pb-[60px]">
  ...
  <div class="wp-block-group container mx-auto relative desktop:px-0 px-[20px]">
    ...
    <!-- /wp:paragraph -->
    <!-- wp:group -->
    <div class="wp-block-group title-wrapper desktop:sticky desktop:top-0 desktop:pt-[20px] desktop:bg-[#f2f2f2] desktop:z-[2] container mx-auto desktop:mb-[120px] mb-[60px] flex">
      <!-- wp:paragraph -->
      <p>
      ...
      <div class="wp-block-group col2 desktop:w-[55%] z-[1]">
        ...
        <div class="wp-block-group gallery-cols relative flex gap-[8px]">
          ...
          <ul class="wp-block-group inner-col1 w-[49%]">
            <!-- wp:list-item -->
            <li class="wp-block-group wide:w-[100%] wide:h-[510px] tile-wrapper relative mb-[12px] rounded-[20px] overflow-hidden">
              <!-- wp:group -->
              ...
              <p>
                <svg width="0" height="0">
                  <defs>
                    <clipPath id="clipped-swiper-serv-1" class="scale-[0.48] desktop:scale-[1.13] wide:scale-[1.2]">
          ...
          <ul class="wp-block-list inner-col2 w-[49%] absolute top-[60px] right-0">
            <!-- wp:list-item -->
            <li class="tile-wrapper wide:w-[100%] wide:h-[510px] relative mb-[12px] rounded-[20px] overflow-hidden">
              <!-- wp:group -->
              <div class="wp-block-group overlay-author z-[1] h-full w-full bg-gradient-to-t from-black via-[rgba(0,0,0,0)] opacity-[40%] absolute top-0 left-0">
                <!-- wp:paragraph -->
                <p class="hidden">overlay</p>
            ...
            <li class="tile-wrapper wide:w-[100%] wide:h-[510px] relative mb-[12px] rounded-[20px] overflow-hidden">
              ...
              <p>
                <svg width="0" height="0">
                  <defs>
                    <clipPath id="clipped-team" class="scale-[0.48] desktop:scale-[0.84] wide:scale-[1.14]">
