...
<div class="wp-block-group meet-us desktop:mb-[150px] mb-[200px]">
  <!-- wp:group -->
  <div class="wp-block-group container relative desktop:px-0 px-[20px]">
    <!-- wp:group -->
    <div class="wp-block-group title-wrapper relative container mx-auto desktop:mb-[120px] mb-[60px] flex desktop:gap-[20px] gap-[0px]">
      ...
      <div class="wp-block-group uslugi-title">
        ...
        <p class="uppercase desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">
          ...
          <span class="relative desktop:text-[50px] text-[24px] uppercase italic before:content-[''] before:inline-block desktop:before:mr-[16px] before:mr-[4px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[3px] before:bg-white">kompleksowo</span>
        </p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
    ...
    <div class="wp-block-group cols-wrapper flex basis mb-[100px]">
      <!-- wp:group -->
      <div class="wp-block-group col1 pl-[105px] basis-[40%]">
        <!-- wp:paragraph -->
