...
<div id="Footer" class="wp-block-group footer">
  ...
  <!-- wp:group -->
  <div class="wp-block-group relative footer2 container mx-auto desktop:px-0 px-[20px] desktop:py-[36px] py-[20px] flex desktop:flex-row flex-col justify-between items-center text-[14px] font-extralight desktop:overflow-hidden">
    <!-- wp:group -->
