...
<div id="O nas" class="wp-block-group o-nas pt-[100px] mb-[50px] desktop:mb-[150px] wide:mb-[220px] ">
  <!-- wp:group -->
  <div class="wp-block-group relative px-[20px] desktop:px-0">
    ...
    <div class="wp-block-group title-wrapper container mx-auto relative desktop:mb-[110px] mb-[80px] desktop:flex gap-[20px]">
      ...
      <div class="wp-block-group uslugi-title is-layout-flow">
        ...
        <div class="wp-block-group hidden overflow-hidden">
          ...
          <div class="wp-block-group overflow-hidden">
            <!-- wp:paragraph -->
            <p data-aos="fade-up" data-aos-duration="600" data-aos-offset="85" class="uppercase desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">działa<span data-aos="fade-up" data-aos-duration="600" data-aos-offset="30" class="relative ml-[12px] desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px] uppercase italic before:content-[''] before:inline-block desktop:before:mr-[18px] before:mr-[8px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-white">jak jeden organizm</span></p>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
        </div>
    ...
    <div class="wp-block-group targets-wrapper desktop:flex gap-x-[80px] wide:gap-x-[200px]">
      ...
      <div class="wp-block-group col2 relative  desktop:basis-[55%]">
        <!-- wp:paragraph -->
        <p data-aos="fade-right" data-aos-duration="600" data-aos-offset="85" class="targets-title desktop:mb-[80px] mb-[60px] max-w-[535px] text-[18px] font-light leading-[30px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. <span class="text-primaryYellow">Ut enim ad minim veniam</span>, quis nostrud exercitation.</p>
        <!-- /wp:paragraph -->
        <!-- wp:list -->
        <ul class="wp-block-list targets-list max-w-[600px] wide:mb-[100px] desktop:mb-[70px] mb-[40px] text-left desktop:flex flex-wrap desktop:justify-start justify-center gap-x-[30px] gap-y-[50px]">
          ...
          <li class="relative mb-[20px] desktop:mb-0 desktop:max-w-[264px] max-w-full flex items-center desktop:list-item gap-[20px]">
            ...
            <div class="wp-block-group counter-index-wrapper min-w-[95px] inline relative">
              ...
              <!-- wp:paragraph -->
              <p data-aos="fade-right" data-aos-duration="600" data-aos-offset="85" class="target-num inline-block desktop:text-[85px] text-[80px] font-semibold">01</p>
              <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
          ...
          <li class="relative mb-[20px] desktop:mb-0 desktop:max-w-[264px] max-w-full flex items-center desktop:list-item gap-[20px]">
            ...
            <div class="wp-block-group counter-index-wrapper min-w-[95px] inline relative">
              ...
              <!-- wp:paragraph -->
              <p data-aos="fade-right" data-aos-duration="600" data-aos-offset="85" class="target-num inline-block desktop:text-[85px] text-[80px] font-semibold">02</p>
              <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
          ...
          <li class="relative mb-[20px] desktop:mb-0 desktop:max-w-[264px] max-w-full flex items-center desktop:list-item gap-[20px]">
            ...
            <div class="wp-block-group counter-index-wrapper min-w-[95px] inline relative">
              ...
              <!-- wp:paragraph -->
              <p data-aos="fade-right" data-aos-duration="600" data-aos-offset="85" class="target-num inline-block desktop:text-[85px] text-[80px] font-semibold">03</p>
              <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
        ...
        <div class="wp-block-group button-wrapper max-w-[535px] flex justify-center items-center gap-[64px]">
          ...
          <ul class="wp-block-list">
            ...
            <li class="wp-block-group">
              <a href="<?php echo get_home_url() . '/about'; ?>" class="uppercase group bg-darkBlack text-white text-[14px] font-bold min-w-[225px] flex justify-center items-center px-[20px] btn-more ml-[0px] p-[15px_30px] border-[2px] rounded-full hover:bg-white hover:text-black" data-aos="fade-right" data-aos-duration="600" data-aos-offset="130"><span class=" overflow-hidden h-[18px]"><span class=" overflow-hidden"><span class=" translate-y-0 group-hover:translate-y-[-22px] transition ease duration-[300ms]">Dowiedz się więcej</span><span class=" translate-y-0 group-hover:translate-y-[-22px] transition ease duration-[300ms]">Dowiedz się więcej</span></span></span></a>
            </li>
            <!-- /wp:list-item -->
          </ul>
          <!-- /wp:list -->
