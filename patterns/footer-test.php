      ...
      <div class="wp-block-group col1 footer-info">
        ...
        <div class="wp-block-group company-info desktop:mb-[120px] mb-[40px] flex gap-[15px]">
          ...
          <figure class="wp-block-image w-[63px]">
            <img src="{{ template_directory_uri }}/wp-content/themes/mutiny/assets/img/front-page/logo-mutiny.png" alt="logo" />
          </figure>
          <!-- /wp:image -->
          <!-- wp:group -->
        ...
        <div class="wp-block-group contact-info-wrapper desktop:mb-[150px] mb-[40px] flex flex-col gap-y-[18px] desktop:leading-[32px] leading-[24px]">
          <!-- wp:paragraph -->
          <p>
            <a href="mailto:kontakt@mutiny.pl" class="w-fit desktop:text-[35px] text-[26px] inline font-medium border-b-[1px] border-white hover:border-primaryYellow hover:text-primaryYellow transition-stroke ease-out duration-300 cursor-pointer">kontakt@mutiny.pl</a>
          </p>
          <!-- /wp:paragraph -->
          <!-- wp:paragraph -->
          <p>
            <a href="tel:+48795123584" class="w-fit desktop:text-[25px] text-[26px] inline font-medium border-b-[1px] border-white hover:border-primaryYellow hover:text-primaryYellow transition-stroke ease-out duration-300 cursor-pointer">+48 795 123 584</a>
          </p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
