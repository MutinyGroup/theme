  ...
  <div class="wp-block-group container mx-auto relative desktop:px-0 px-[20px]">
    ...
    <div class="wp-block-group title-wrapper relative container mx-auto desktop:mb-[120px] mb-[60px] desktop:flex z-[1]">
      ...
      <div class="wp-block-group h-fit overflow-hidden">
        <!-- wp:paragraph -->
        <p data-aos="fade-up" data-aos-duration="600" data-aos-offset="130" class="section-title desktop:basis-auto desktop:w-[145px] basis-[20%] uppercase text-primaryYellow pt-[4px] pr-[20px]">Nasze <br> podejście</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
            ...
            <div class="wp-block-group mb-[95px]">
              ...
              <ul class="wp-block-list leading-[32px] font-semibold">
                ...
                <li class="flex items-center gap-[10px] ">
                  <p data-aos="fade-right" data-aos-duration="600" data-aos-offset="85" class="inline before:content-[''] before:inline before:mr-[5px] before:mb-[5px] before:w-[20px] before:h-[2px] before:bg-primaryYellow">Lorem ipsum dolor sit amet</p>
                </li>
                <!-- /wp:list-item -->
                <!-- wp:list-item -->
