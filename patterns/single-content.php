...
<div class="wp-block-group single-page-post mb-[150px]">
  ...
  >    
    ...
    <!-- wp:group -->
    <div class="wp-block-group layout-two-cols mb-[50px] flex gap-[50px]">
      <!-- wp:group -->
      ...
      <!-- wp:group -->
      <div class="wp-block-group share-wrapper w-[30%] h-[80px]">
        <!-- wp:group -->
        <div class="wp-group-block share-border w-fit pt-[25px] border-[#D5D5D5] border-t-[2px] flex gap-[20px]">
          <!-- wp:paragraph -->
