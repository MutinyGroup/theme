...
<div id="Eventy" class="wp-block-group page-realizations-events mb-[150px] overflow-hidden">
  <!-- wp:group -->
  <div id="realizationsContainer" class="wp-block-group container mx-auto max-h-[1500px] relative desktop:px-0 px-[20px] overflow-y-hidden transition-height ease-in-out duration-[800ms]">
    <!-- wp:list -->
          ...
          if (true) { ?>
            ...
            <li class="event-tile group mb-[50px] max-h-[400px]">
              <a href="<?php the_permalink(); ?>" class="wp-block-group tile-container h-full desktop:flex gap-[75px]" data-aos="fade-right" data-aos-duration="600" data-aos-offset="130">
                <!-- wp:group -->
                <div class="wp-block-group event-image-wrapper desktop:mb-0 mb-[20px] min-h-[400px] overflow-hidden w-full rounded-[20px]">
                  <!-- wp:image -->
