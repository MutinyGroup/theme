...
<div id="Banner" class="wp-block-group realizations-banner group h-auto desktop:mb-[150px] pt-[80px] desktop:pt-0">
  <!-- wp:group -->
    ...
    <div class="wp-block-group title-wrapper relative desktop:mb-[58px] mb-[40px] desktop:mt-[90px]">
      ...
      <div id="title" class="wp-block-group title-wrapper relative container mx-auto desktop:flex">
        ...
        <div class="wp-block-group uslugi-title uppercase font-medium desktop:text-[60px] text-[30px] desktop:leading-[60px] leading-[30px]">
          <!-- wp:paragraph -->
          <p>PROJEKTY Z KTÓRYCH</p>
          <!-- /wp:paragraph -->
          <!-- wp:paragraph -->
          <p class="inline">JESTEŚMY</p>
          <!-- /wp:paragraph -->
         <!-- wp:paragraph {"templateLock":"contentOnly"} -->
         <p class="relative inline-block uppercase italic before:content-[''] before:inline-block desktop:before:mr-[8px] before:mr-[4px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-black">DUMNI</p>
          <!-- /wp:paragraph -->
          <!-- wp:paragraph -->
