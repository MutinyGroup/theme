...
<div id="Eventy" class="wp-block-group page-realizations-events mb-[150px] overflow-hidden">
  <!-- wp:group -->
  <div id="realizationsContainer" class="wp-block-group container mx-auto max-h-[1500px] relative desktop:px-0 px-[20px] overflow-y-hidden transition ease-out duration-300">
    <!-- wp:list -->
