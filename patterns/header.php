...
<div id="Mobile" class="wp-block-group nav-mobile h-[60px] desktop:hidden container mx-auto px-[20px] bg-[#101010] z-[4] fixed top-0 left-0 transition ease-out duration-300">
  <!-- wp:group -->
