  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px] wide:h-[900px] desktop:h-[790px] h-fit">
    ...
    <div class="wp-block-group content-with-bg-wrapper">
      ...
      <div class="wp-block-group left-col relative wide:pt-[110px] desktop:pt-[80px] pt-0 fullhd:text-[85px] desktop:text-[85px] text-[38px] font-normal desktop:w-[940px] wide:leading-[85px] desktop:leading-[80px] leading-[38px]">
        <!-- wp:group -->
        <div class="wp-block-group flash-wrapper wide:scale-[1.2] desktop:scale-[1.1] scale-[0.5] absolute desktop:top-[-130px] top-[-350px] left-[-200px] desktop:left-[-140px] z-[-1]">
          <!-- wp:paragraph -->
      ...
      <div class="wp-block-group right-col banner-bg h-[300px] desktop:h-[775px] wide:h-[950px] desktop:w-[44%] w-[65%] absolute right-0 desktop:top-[50px] top-[30px] z-[-1]">
        ...
        <svg width="0" height="0">
          <defs>
            <clipPath id="clipped-banner" class="scale-[0.4] tablet:scale-[0.8] desktop:scale-[1.1] wide:scale-[1.35]">
