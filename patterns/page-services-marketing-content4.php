...
<!-- wp:group -->
<div class="wp-block-group page-marketing my-[150px]">
  <!-- wp:group -->
  <div
  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <!-- wp:paragraph -->
          <p class="desktop:justify-self-end pt-[3px] pr-[15px]">04</p>
          <!-- /wp:paragraph -->
        </div>  
        <!-- /wp:group -->
    ...
    <div class="wp-block-group page-marketing-content my-[150px]">
      ...
      <div class="wp-block-group desktop:mt-[-120px] w-full">
        ...
        <div id="marketing2" class="wp-block-group swiper swiperMarketing2 relative desktop:pt-[60px] absolute top-0 desktop:left-[150px] left-[20px]">
          <!-- wp:group -->
          <div id="marketing2-prev" class="wp-block-group group swiper-button-prev w-[56px] h-[56px] absolute top-[50%] desktop:right-[50px]">
            <!-- wp:paragraph -->
          ...
          <!-- wp:group -->
          <div id="marketing2-next" class="wp-block-group group swiper-button-next w-[56px] h-[56px] absolute top-[50%] desktop:right-[0px]">
            <!-- wp:paragraph -->
