...
<div id="2xKafelki" class="wp-block-group page-marketing-info">
  ...
  >
    <!-- wp:group -->
    <div
      class="wp-block-group title-wrapper relative desktop:mb-[100px] mb-[40px] desktop:pt-[90px] pt-[20px]"
    >
      <!-- wp:group -->
      <div
    ...
    <div class="wp-block-group page-marketing-content">
      ...
      <!-- wp:group -->
      <div class="wp-block-group gallery desktop:mb-[240px] mb-[150px] relative mb-[100px] flex gap-[8px]">
        <!-- wp:image -->
