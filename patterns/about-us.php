    ...
    <div class="wp-block-group title-wrapper container mx-auto relative desktop:mb-[110px] mb-[80px] flex gap-[20px]">
      ...
      <div class="wp-block-group uslugi-title is-layout-flow">
        ...
        <div class="wp-block-group overflow-hidden">
          ...
          <div class="wp-block-group overflow-hidden">
            <!-- wp:paragraph -->
            <p data-aos="fade-up" data-aos-duration="6000" class="uppercase inline-block desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">(v2) Holistyczne podejście do działań</p>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
          <!-- wp:group -->
          <div class="wp-block-group overflow-hidden">
            <!-- wp:paragraph -->
            <p data-aos="fade-up" data-aos-duration="6000" class="uppercase inline-block desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">reklamowych sprawia, że nasza firma </p>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
          <!-- wp:group -->
          <div class="wp-block-group overflow-hidden">
            <!-- wp:paragraph -->
            <p data-aos="fade-up" data-aos-duration="6000" class="uppercase inline-block desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">działa<span data-aos="fade-up" class="relative ml-[12px] desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px] inline-block uppercase italic before:content-[''] before:inline-block desktop:before:mr-[18px] before:mr-[8px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-white">jak jeden organizm</span></p>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:group -->
        </div>
