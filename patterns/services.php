...
<div id="Usługi" class="wp-block-group uslugi desktop:mb-[150px] mb-[80px]">
  ...
  <div class="wp-block-group desktop:mb-[150px] mb-[80px] relative">
    ...
    <div class="wp-block-group mt-[80px] desktop:mt-[-120px] w-full h-[660px] overflow-hidden">
      ...
      <!-- wp:group -->
      <div id="services" class="wp-block-group swiper swiperServices desktop:w-[calc(100%-90px)] desktop:pt-[180px] absolute top-0 desktop:top-[160px] left-[20px] desktop:left-[45px]">
            ...
            if($post_query->have_posts() ) {
              ...
              ?>
                ...
                <div class="wp-block-group swiper-slide swiper-slide-services relative z-[2] group p-[25px] wide:max-w-[420px] desktop:max-w-[354px] max-w-[310px] h-[380px] desktop:h-[450px] wide:h-[530px] rounded-[20px] transition ease-out duration-300 mr-[8px] <?php if($counter == 1) echo 'clipped-swiper-serv-1'; elseif($counter == $post_query->post_count) echo 'clipped-swiper-serv-2'; ?>">
                  ...
                  <!-- wp:paragraph -->
                  <p class="hover-text w-[250px] mt-[270px] wide:mt-[350px] translate-y-[70px] opacity-[0%] group-hover:opacity-[100%] group-hover:translate-y-[30px] transition-all ease-out duration-500 text-[15px] font-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet in aspernatur alias ipsa, fuga ut!
                  </p>
                  <!-- /wp:paragraph -->
                </div>
                <!-- /wp:group -->            
