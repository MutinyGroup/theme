    ...
    <div class="wp-block-group title-wrapper relative container mx-auto desktop:ml-[120px] ml-0 desktop:pt-[100px] desktop:mt-0 mt-[60px] desktop:mb-[80px] desktop:flex gap-[20px]">
      ...
      <div class="wp-block-group uslugi-title is-layout-flow">
        ...
        <div class="wp-block-group overflow-hidden">
          <!-- wp:paragraph -->
          <span data-aos="fade-up" data-aos-duration="600" data-aos-offset="30" class="uppercase desktop:text-[35px] text-[26px] font-medium leading-[40px]">Co mówią nasi klienci?</span>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
      ...
      <div id="opinions-bright" class="wp-block-group swiper swiperOpinions w-full desktop:w-[560px] ml-0 overflow-visible">
        ...
        <ul class="wp-block-list swiper-wrapper">
          ...
          <li class="swiper-slide relative z-[2] group desktop:max-w-[444px] max-w-[80%] desktop:h-[430px] max-h-[530px] mr-[40px] desktop:mr-[90px] opacity-0 transition duration-[300ms] ease-out">
            ...
            <!-- /wp:group -->
            <!-- wp:paragraph -->
            <span data-aos="fade-right" data-aos-duration="600" data-aos-offset="30" class="opinion-text desktop:text-[20px] text-[18px] font-light mb-[50px] desktop:mt-0 mt-[30px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
            </span>
            <!-- /wp:paragraph -->
            <!-- wp:group -->
          ...
          <li class="swiper-slide relative z-[2] group desktop:max-w-[444px] max-w-[80%] desktop:h-[430px] max-h-[530px] mr-[40px] desktop:mr-[90px] opacity-0 transition duration-[300ms] ease-out">
            ...
            <!-- /wp:group -->
            <!-- wp:paragraph -->
            <span class="opinion-text desktop:text-[20px] text-[18px] font-light mb-[50px] desktop:mt-0 mt-[30px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
            </span>
            <!-- /wp:paragraph -->
            <!-- wp:group -->
            <div class="wp-block-group opinion-author my-[50px] flex gap-[20px]">
