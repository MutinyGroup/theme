                        ...
                        <div class="wp-block-group mb-[20px]">
                          ...
                          <div class="wp-block-group h-[360px] desktop:h-[550px] overflow-hidden rounded-[20px]">
                            ...
                            <svg x="0px" y="0px" viewBox="0 0 1374.7 1083.6" class="absolute top-0" >
                              <defs>
                                <clipPath id="clipped-blog" class="scale-[0.00175] desktop: scale-[0.00175] scale-y-[0.00165] desktop:scale-y-[0.00175] wide:scale-y-[0.001725]" clipPathUnits="objectBoundingBox">
