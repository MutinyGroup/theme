...
<!-- wp:group -->
<div class="wp-block-group about-banner desktop:h-[780px] h-screen mb-[150px]">
  <!-- wp:group -->
  <div
  ...
  >
    ...
    >
      ...
      >
        ...
        <!-- /wp:group -->
        <!-- wp:group -->
        <div class="wp-block-group uslugi-title uppercase font-semibold desktop:text-[60px] text-[30px] desktop:leading-[60px] leading-[30px]">
          <!-- wp:paragraph -->
          <p
            class=""
          >
            ...
            <span
              ...
              >granic<span class="desktop:text-[150px] text-[70px] leading-[1px] desktop:leading-auto">.</span></span
            >
          </p>
          <!-- /wp:paragraph -->
        </div>
