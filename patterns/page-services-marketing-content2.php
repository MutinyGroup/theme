    ...
    <div class="wp-block-group title-wrapper relative desktop:mb-[58px] mb-[40px] pt-[90px]">
      ...
      <div class="wp-block-group title-wrapper relative desktop:flex">
        ...
        <div class="wp-block-group uslugi-title uppercase font-medium desktop:text-[50px] text-[24px] desktop:leading-[60px] leading-[30px]">
          <!-- wp:paragraph -->
          <p class="uppercase">content<span class="relative inline desktop:text-[50px] text-[24px] uppercase italic before:content-[''] before:inline-block desktop:before:mr-[8px] before:mr-[4px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-black">Marketing</span></p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
    ...
    <div class="wp-block-group page-marketing-content">
      ...
      <div class="wp-block-group">
        ...
        <div class="wp-block-group desktop:mt-[-120px] w-full">
          <!-- wp:group -->
          <div id="marketing" class="wp-block-group swiper swiperMarketing desktop:pt-[180px] absolute top-0 desktop:left-[150px] left-[20px]">
            <!-- wp:group -->
