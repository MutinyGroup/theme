...
<ul id="Desktop" class="wp-block-list nav-desktop h-[60px] desktop:h-[90px] hidden desktop:flex justify-center items-center relative z-[3]">
  ...
  ?>
    ...
    <li class="wp-block-group lang-btn group h-[48px] hover:h-[120px] hidden desktop:block p-[10px_12px] text-center uppercase font-medium border-[2px] border-[#AAAAAA] rounded-[50px] hover:rounded-[20px] absolute top-[20px] right-[20px] cursor-pointer hover:bg-white hover:border-white hover:text-black transition-height ease-out duration-300">
      <a class="block hover:text-primaryYellow group-hover:mb-[10px]" href="http://mutiny.webo.design/">PL</a>
  ...
  ?>
    <!-- wp:list-item -->
    <li class="wp-block-group lang-btn group h-[48px] hover:h-[120px] hidden desktop:block p-[10px_12px] text-center uppercase font-medium border-[2px] border-[#AAAAAA] rounded-[50px] hover:rounded-[20px] absolute top-[20px] right-[20px] cursor-pointer hover:bg-white hover:border-white hover:text-black transition-height ease-out duration-300">
      <a class="block hover:text-primaryYellow group-hover:mb-[10px]" href="http://mutiny.webo.design/eng/">ENG</a>
  ...
  ?>
    <!-- wp:list-item -->
    <li class="wp-block-group lang-btn group h-[48px] hover:h-[120px] hidden desktop:block p-[10px_12px] text-center uppercase font-medium border-[2px] border-[#AAAAAA] rounded-[50px] hover:rounded-[20px] absolute top-[20px] right-[20px] cursor-pointer hover:bg-white hover:border-white hover:text-black transition-height ease-out duration-300">
      <a class="block hover:text-primaryYellow group-hover:mb-[10px]">SE</a>
      <a class="block hover:text-primaryYellow group-hover:mb-[10px] opacity-0 group-hover:opacity-100 transition ease-out duration-300" href="http://mutiny.webo.design/eng/" href="http://mutiny.webo.design/">PL</a>
      <a class="block hover:text-primaryYellow opacity-0 group-hover:opacity-100 transition ease-out duration-300" href="http://mutiny.webo.design/se/">ENG</a>
    </li>
    <!-- /wp:list-item -->
  <?php
  };
