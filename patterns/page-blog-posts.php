...
<div id="Posty" class="wp-block-group page-blog-posts mb-[80px] desktop:mb-[150px]  pt-[80px] desktop:pt-0 overflow-hidden">
  <!-- wp:group -->
  <div id="blogContainer" class="wp-block-group container max-h-[1460px] mx-auto relative mb-[80px] desktop:mb-[100px] px-[20px] desktop:px-0 overflow-y-hidden transition-height ease-in-out duration-[800ms]">
    <!-- wp:group -->
      ...
      <ul class="wp-block-list blog-posts-wrapper flex flex-wrap desktop:justify-center desktop:gap-x-[100px] wide:gap-x-[100px] gap-y-[40px] desktop:gap-y-[200px]">
        ...
        if ($post_query->have_posts()) {
          while ($post_query->have_posts()) {
            ...
            if ($tab[$i] == 0) { ?>
              <!-- wp:list-item -->
              <li class="bigger relative group w-full slideBlog opacity-0 desktop:w-[535px] wide:w-[580px] h-fit desktop:h-[545px] wide:h-[650px] transition duration-[800ms] ease-in <?php echo (!($counter % 2)) ? 'pt-[120px]' : ''; ?>">
