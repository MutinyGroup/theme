...
<div id="O nas" class="wp-block-group o-nas pt-[100px] mb-[200px] desktop:mb-[150px] wide:mb-[220px] ">
  ...
  <div class="wp-block-group relative px-[20px] desktop:px-0">
    <!-- wp:group -->
    <div class="wp-block-group title-wrapper container mx-auto relative desktop:mb-[150px] mb-[80px] flex gap-[20px]">
      <!-- wp:paragraph -->
      ...
      <div class="wp-block-group uslugi-title is-layout-flow">
          ...
          <!-- wp:paragraph -->
          <p class="uppercase inline desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">Holistyczne podejście do działań reklamowych sprawia, że nasza firma działa</p>
          <!-- /wp:paragraph -->
          <!-- wp:paragraph {"templateLock":"contentOnly"} -->
          <p class="relative desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px] inline-block uppercase italic before:content-[''] before:inline-block desktop:before:mr-[8px] before:mr-[4px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-white">jak jeden organizm</p>
          <!-- /wp:paragraph -->
          <!-- wp:paragraph -->
      ...
      <div class="wp-block-group col2 relative  desktop:basis-[55%]">
        ...
        <div class="wp-block-group button-wrapper flex items-center gap-[64px]">
          ...
          <div class="wp-block-buttons btn-more cursor-pointer ml-[0px] p-[15px_30px] uppercase border-[2px] border-white rounded-full desktop:static absolute desktop:bottom-[-30px] bottom-[-80px] desktop:left-[0px] left-[50%] desktop:translate-x-0 translate translate-x-[-50%] hover:bg-white hover:text-black transition ease-out duration-300">
            <!-- wp:paragraph -->
            <p class="uppercase w-[140px] text-[14px] font-bold">
              <a href="<?php echo get_home_url() . '/about' ?>">Dowiedz się więcej</a>
            </p>
            <!-- /wp:paragraph -->
          </div>
          <!-- /wp:buttons -->
