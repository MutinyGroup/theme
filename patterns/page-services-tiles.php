  ...
  <div class="wp-block-group container mx-auto relative desktop:px-0 px-[20px]">
    ...
    <div class="wp-block-group above-wp-query">
      ...
      <div class="wp-block-group above-post-template-services ul-wrapper mx-auto w-[100%] wide:max-w-[1100px]">
        ...
        <!-- wp:group -->
        <div class="wp-block-group swiper-slide servicesTile relative group desktop:w-full w-[100%] desktop:h-[600px] h-[320px] transition duration-[800ms] ease-in">
          <!-- wp:group -->
          <div class="wp-block-group h-full w-full">
            ...
            <!-- wp:paragraph -->
            <p class="btn-swiper-more group z-[2] pr-[20px] desktop:pr-0 text-[14px] font-semibold uppercase absolute  desktop:bottom-[75px] bottom-[20px] desktop:left-[25px] left-[20px] transition ease-out duration-300"><a href="<?php echo get_permalink(); ?>">Dowiedz się więcej <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none " class="inline-block ml-[10px]">
    ...
    <!-- wp:group -->
    <div class="wp-block-group hidden _hidden-wpquery-need gallery-cols relative pb-[150px]">
      <!-- wp:list -->
