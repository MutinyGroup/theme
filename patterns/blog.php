    ...
    <div class="wp-block-group title-wrapper relative container mx-auto desktop:px-0 px-[20px] desktop:mb-[0px] mb-[40px] desktop:flex gap-[20px] z-[1]">
      ...
      <div class="wp-block-group blog-title z-[1]">
        ...
        <div class="wp-block-group overflow-hidden">
          <!-- wp:heading -->
          <h2><span data-aos="fade-up" data-aos-duration="600" data-aos-offset="30" class="uppercase inline-block desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">Aktualności i wydarzenia</span></h2>
          <!-- /wp:heading -->
        </div>
        <!-- /wp:group -->
        <!-- wp:group -->
