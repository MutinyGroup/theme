...
<div class="wp-block-group zaufali-nam mb-[80px] desktop:mb-[150px]">
  ...
  <!-- /wp:group -->
      ...
      <!-- wp:group -->
      <div class="h-[120px] w-full px-[50px] bg-white flex items-center absolute bottom-0 desktop:left-[11%] left-[20px] is-layout-flow">
        <!-- wp:paragraph -->
        ...
        <div class="logos-wrapper flex items-center gap-[100px]">
          ...
          <!-- wp:image -->
          <figure class="wp-block-image">
            <img src="https://mutiny.webo.design/wp-content/themes/mutiny/assets/img/page-about/logos-companies/logo-sport.png" alt="company-logo" class="max-h-[80px]">
          </figure>
          <!-- /wp:image -->
          <!-- wp:image -->
          <figure class="wp-block-image">
