  ...
  <div class="wp-block-group container relative mx-auto desktop:px-0 px-[20px]">
    ...
    <div class="wp-block-group title-wrapper relative desktop:mb-[150px] mb-[50px] desktop:flex gap-[20px]">
      ...
      <div class="wp-block-group realizations-title z-[1] relative">
        <!-- wp:heading -->
        <h2><span class="block overflow-hidden"><span data-aos="fade-up" data-aos-duration="600" data-aos-offset="30" class="uppercase inline-block desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">Zobacz efekty</span></span><span class="block overflow-hidden"><span data-aos="fade-up" data-aos-duration="600" data-aos-offset="30" class="relative ml-[12px] desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px] inline-block uppercase italic before:content-[''] before:inline-block desktop:before:mr-[18px] before:mr-[8px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-white">naszej pracy</span></span></h2>
        <!-- /wp:heading -->
      </div>
      <!-- /wp:group -->
    </div>
    <!-- /wp:group -->
    <!-- wp:paragraph -->
    <span data-aos="fade-right" data-aos-duration="600" data-aos-offset="85" class="sub-title mb-[50px] desktop:mb-0 desktop:max-w-[400px] max-w-full desktop:text-[20px] text-[16px] font-light desktop:leading-[30px] leading-[26px] desktop:absolute desktop:left-[65%] desktop:top-[40px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore <span class="text-primaryYellow">et dolore magna aliqua. </span></span>
    <!-- /wp:paragraph -->
    <!-- wp:paragraph -->
    <span data-aos="fade-right" data-aos-duration="600" data-aos-offset="85" class="wp-block-group circle-title hidden w-[120px] h-[120px] mx-0 leading-[20px] desktop:flex items-center justify-center flex-col rounded-full border-[4px] border-[#D5D5D5] absolute desktop:top-[160px] top-[80px] desktop:left-[60%] left-[75px] translate-x-[-50%]">
                ...
                <div class="wp-block-group tile-realizacje block mb-[30px] desktop:w-[510px] wide:w-[600px] h-[480px] desktop:h-[700px] wide:h-[780px] relative group transition ease-in-out duration-[400ms] group hover:before:opacity-100 before:content-[''] before:opacity-0 before:absolute before:top-0 before:left-0 before:z-[1] before:w-full before:h-full before:bg-gradient-to-t before:from-black before:via-[rgba(0,0,0,0)] before:bg-center before:bg-cover before:transition before:duration-[300ms] before:ease-out <?php echo (($counter % 2)) ? "tile-realizacje-1 clip-path-url-['#clipped-realizations-1']" : "tile-realizacje-2 clip-path-url-['#clipped-realizations-2'] desktop:mt-[70px]"; ?>">
                  ...
                  <div class="wp-block-group w-full h-full">
                    ...
                    <div class="wp-block-group tile-title z-[1] absolute bottom-[50px] desktop:left-[50px] left-[20px] pr-[20px]">
                      <!-- wp:paragraph -->
                      <p class="w-fit desktop:text-[35px] text-[26px] desktop:mb-[20px] mb-[10px] desktop:leading-[42px] leading-[38px] font-semibold desktop:group-hover:translate-y-[-50px] group-hover:translate-y-[-70px] transition ease-in-out duration-[400ms] cursor-pointer"><a href="<?php echo get_permalink(); ?>"><?php the_title(); ?></a></p>
                      <!-- /wp:paragraph -->
