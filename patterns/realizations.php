    ...
    <div class="wp-block-group title-wrapper relative desktop:mb-[150px] mb-[50px] desktop:flex gap-[20px]">
      ...
      <div class="wp-block-group realizations-title z-[1] relative">
        ...
        <div class="wp-block-group overflow-hidden">
          <!-- wp:paragraph -->
          <h2 data-aos="fade-up" data-aos-duration="600" data-aos-offset="30" class="uppercase inline desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">Zobacz efekty</h2>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
        ...
        <div class="wp-block-group overflow-hidden">
          ...
          <h2 data-aos="fade-up" data-aos-duration="600" data-aos-offset="30" class="relative ml-[12px] desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px] inline-block uppercase italic before:content-[''] before:inline-block desktop:before:mr-[18px] before:mr-[8px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-white">naszej pracy</h2>
          <!-- /wp:paragraph -->
