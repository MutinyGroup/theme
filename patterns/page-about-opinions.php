  ...
  <div class="wp-block-group relative mx-auto desktop:ml-[83px] desktop:px-0 px-[20px] overflow-hidden bg-white">
    ...
    <div class="wp-block-group swiper-section-wrapper relative desktop:flex">
      ...
      <div class="wp-block-group swiper-nav-wrapper desktop:block hidden relative w-[40%] z-2">
        <!-- wp:group -->
        <div id="opinions-prev" class="wp-block-group group swiper-button-prev w-[56px] h-[56px] absolute desktop:top-[60px] top-[0px] wide:left-[330px] desktop:left-[200px] left-[130px]">
          <!-- wp:paragraph -->
        ...
        <!-- wp:group -->
        <div id="opinions-next" class="wp-block-group group swiper-button-next w-[56px] h-[56px] absolute desktop:top-[60px] top-[0px] wide:left-[400px] desktop:left-[270px] left-[200px]">
          <!-- wp:paragraph -->
      ...
      <!-- wp:group -->
      <div id="opinions-bright" class="wp-block-group swiper swiperOpinions desktop:max-w-[464px] ml-0 overflow-visible">
        <!-- wp:group -->
        <div class="wp-block-group swiper-wrapper">
          <!-- wp:group -->
          <div class="wp-block-group swiper-slide relative z-[2] group desktop:max-w-[444px] max-w-[280px] desktop:h-[430px] max-h-[530px] mr-[20px]">
            <!-- wp:group -->
