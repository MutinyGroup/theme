      ...
      <ul class="wp-block-list blog-posts-wrapper flex flex-wrap desktop:justify-center desktop:gap-x-[60px] wide:gap-x-[100px] gap-y-[40px] desktop:gap-y-[140px]">
        ...
        if ($post_query->have_posts()) {
          while ($post_query->have_posts()) {
            ...
            if ($tab[$i] == 0) { ?>
              <!-- wp:list-item -->
              <li class="wp-block-group bigger swiper-slide relative group w-full desktop:w-[535px] wide:w-[580px] h-fit desktop:h-[675px] wide:h-[756px] <?php if (!($counter % 2)) echo 'desktop:translate-y-[120px]';
                                                                                                                                                          else echo ''; ?>">
            ...
            <?php
              ...
              <!-- wp:list-item -->
              <li class="wp-block-group smaller swiper-slide relative group w-full desktop:w-[444px] wide:w-[490px] h-fit desktop:h-[675px] <?php if (!($counter % 2)) echo 'desktop:translate-y-[120px]';
                                                                                                                                            else echo ''; ?>">
                <a href="<?php the_permalink(); ?>">
                  <!-- wp:group -->
