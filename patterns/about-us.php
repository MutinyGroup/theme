  ...
  <div class="wp-block-group relative px-[20px] desktop:px-0">
    ...
    <div class="wp-block-group title-wrapper container mx-auto relative desktop:mb-[150px] mb-[80px] flex gap-[20px]">
      ...
      <div class="wp-block-group uslugi-title is-layout-flow">
          ...
          <!-- wp:paragraph -->
          <p class="inline">Holistyczne podejście do działań reklamowych sprawia, że nasza firma działa</p>
          <!-- /wp:paragraph -->
          <!-- wp:paragraph {"templateLock":"contentOnly"} -->
          <p class="relative inline-block uppercase italic before:content-[''] before:inline-block desktop:before:mr-[8px] before:mr-[4px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-black">jak jeden organizm</p>
          <!-- /wp:paragraph -->
          <!-- wp:paragraph -->
