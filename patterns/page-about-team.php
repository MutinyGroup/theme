...
<div id="Team Mutiny" class="wp-block-group meet-us mb-[80px] desktop:mb-[150px] desktop:pb-0 pb-[60px]">
  ...
  <div class="wp-block-group container mx-auto relative desktop:px-0 px-[20px]">
    ...
    <!-- /wp:paragraph -->
    <!-- wp:group -->
    <div class="wp-block-group title-wrapper desktop:sticky desktop:top-0 desktop:pt-[40px] desktop:bg-[#f2f2f2] desktop:z-[2] container mx-auto desktop:mb-[120px] mb-[60px] flex">
      <!-- wp:paragraph -->
