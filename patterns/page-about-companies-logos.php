...
<div class="wp-block-group zaufali-nam mb-[80px] desktop:mb-[150px]">
  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px]">
    ...
    <!-- wp:group -->
    <div id="logos" class="wp-block-group swiper mobile desktop:hidden">
      <!-- wp:group -->
    ...
    <!-- wp:group -->
    <div class="wp-block-group companies-wrapper-desktop hidden desktop:flex gap-x-[110px] gap-y-[40px] flex-wrap items-center justify-center">
      <!-- wp:core/image -->
