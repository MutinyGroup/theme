...
<div class="wp-block-group opinions desktop:mb-[150px] mb-[60px]">
  ...
  <div class="wp-block-group relative mx-auto desktop:ml-[83px] desktop:px-0 px-[20px] overflow-hidden bg-black">
    ...
    <!-- wp:group -->
    <div class="wp-block-group swiper-section-wrapper desktop:flex">

      <!-- wp:group -->
      <div class="wp-block-group swiper-nav-wrapper desktop:block hidden relative basis-[50%] z-0">
        <!-- wp:group -->
        <div class="wp-block-group swiper-button-prev w-[100px] absolute desktop:top-[60px] top-[0px] desktop:left-[170px] left-[130px]">
          <!-- wp:paragraph -->
          <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 56 56" fill="none" class="rotate-180">
        ...
        <!-- wp:group -->
        <div class="wp-block-group swiper-button-next w-[100px] absolute desktop:top-[60px] top-[0px] desktop:left-[240px] left-[200px]">
          <!-- wp:paragraph -->
        ...
        <!-- wp:group -->
        <div class="wp-block-group swiper-pagination text-primaryYellow text-[50px] absolute desktop:left-[190px] left-[100px] desktop:top-[110px] top-[-70px]">
          <!-- wp:paragraph -->
      ...
      <!-- wp:group -->
      <div class="wp-block-group swiper swiperOpinions overflow-x-scroll">
        <!-- wp:group -->
        <div class="wp-block-group swiper-wrapper overflow-x-scroll">
          ...
          <div class="wp-block-group swiper-slide relative z-[2] group desktop:max-w-[444px] max-w-[280px] desktop:h-[430px] max-h-[530px] cursor-pointer mr-[20px]">
            ...
            <div class="wp-block-group opinion-author my-[50px] flex gap-[20px]">
              ...
              <figure class="wp-block-image avatar rounded-full w-[60px] overflow-hidden">
                <img src="https://mutiny.webo.design/wp-content/themes/mutiny/assets/img/avatars-opinions/avatar1.jpg" alt="avatar">
              </figure>
              <!-- /wp:image -->
              <!-- wp:group -->
              <div class="wp-block-group author-wrapper">
                <!-- wp:paragraph -->
                <p class="author-name font-semibold">Mateusz Rowan</p>
                <!-- /wp:paragraph -->
                <!-- wp:paragraph -->
                <p class="author-company font-light">Dyrektor, Galeria Metropolia</p>
                <!-- /wp:paragraph -->
              </div>
              <!-- /wp:group -->
            </div>
          ...
          <div class="wp-block-group swiper-slide relative z-[2] group desktop:max-w-[444px] max-w-[280px] desktop:h-[430px] max-h-[530px] cursor-pointer mr-[20px]">
            ...
            <!-- /wp:group -->
            <!-- wp:paragraph -->
            <p class="opinion-text opacity-[50%] desktop:text-[20px] text-[18px] font-light mb-[50px] desktop:mt-0 mt-[30px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
            </p>
            <!-- /wp:paragraph -->
            <!-- wp:group -->
            <div class="wp-block-group opinion-author my-[50px] flex gap-[20px]">
