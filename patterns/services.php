  ...
  <div class="wp-block-group desktop:mb-[150px] mb-[80px] pt-[100px] desktop:pt-0 relative overflow-hidden desktop:overflow-visible">
    ...
    <div class="wp-block-group mt-[80px] desktop:mt-[-120px] w-full h-[380px] desktop:h-[660px] wide:h-[720px] overflow-hidden swiper-services-editor">
      ...
      <div id="services" class="wp-block-group swiper swiperServices w-screen desktop:w-[calc(100%-90px)] desktop:pt-[180px] absolute top-[400px] desktop:top-[160px] left-[20px] desktop:left-[90px]">
        <!-- wp:list -->
        <ul class="wp-block-list swiper-wrapper desktop:h-[480px] wide:h-[530px]">
          <?php
          $args = array(
            'post_type' => 'uslugi',
            'posts_per_page' => 6,
          ...
          ?>
              <!-- wp:list-item -->
              <li class="swiper-slide swiper-slide-services wide:max-w-[420px] desktop:max-w-[354px] max-w-[310px] h-[380px] desktop:h-[450px] wide:h-[530px]">
                <a href="<?php the_permalink(); ?>" class="relative z-[2] group p-[25px] wide:max-w-[420px] desktop:max-w-[354px] max-w-[310px] h-[380px] desktop:h-[450px] wide:h-[530px] rounded-[20px] text-[18px] flex items-center before:hover:opacity-100 after:hover:opacity-100 wide:before:h-[530px] wide:after:h-[530px] transition ease-out duration-300 mr-[8px] before:content-[''] before:opacity-0 before:absolute before:top-0 before:left-0 before:z-[2] before:w-full before:h-[450px] before:bg-gradient-to-t before:from-black before:via-[rgba(0,0,0,0)] before:bg-center before:bg-cover before:transition before:duration-[300ms] before:ease-out before:grayscale after:content-[''] after:opacity-0 after:absolute after:top-0 after:left-0 after:z-[2] after:w-[354px] after:h-[450px] after:transition after:duration-[300ms] after:ease-out after:grayscale <?php echo ($counter == 1) ?  "clip-path-url-['#clipped-swiper-serv-1']" : (($counter == $post_query->post_count) ? "clip-path-url-['#clipped-swiper-serv-2']" : ''); ?>" data-aos="fade-right" data-aos-duration="600" data-aos-offset="130">
                  ...
                  <div class="wp-block-group text-wrapper slide-title absolute desktop:bottom-[85px] bottom-[100px] left-[25px] group-hover:translate-y-[-80px] transition ease-out duration-500 z-[3]">
                    <!-- wp:paragraph -->
                    <p class="mr-[20px] text-[25px] font-semibold mb-[15px] underline-offset-[7px] group-hover:underline group-hover:decoration-primaryYellow group-hover:translate-y-[-80px] transition ease-out duration-500"><?php the_title(); ?></p>
                    <!-- /wp:paragraph -->
                  </div>
                  <!-- /wp:group -->
    ...
    <div class="wp-block-group button-wrapper container mx-auto mt-[50px] wide:mt-[120px] flex items-center justify-center gap-[64px]">
      ...
      <ul class="wp-block-list">
        ...
        <li class="wp-block-group">
          <a href="<?php echo get_home_url() . '/services'; ?>" class="uppercase group bg-darkBlack text-white text-[14px] font-bold min-w-[225px] flex justify-center items-center px-[20px] btn-more ml-[0px] p-[15px_30px] border-[2px] rounded-full hover:bg-white hover:text-black">
            <!-- wp:group -->
