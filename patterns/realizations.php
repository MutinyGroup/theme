...
<div id="Realizacje" class="wp-block-group realizacje relative desktop:pt-[220px] pt-[180px] desktop:mb-[200px] mb-[60px] overflow-visible">
  ...
  <div class="wp-block-group container relative mx-auto desktop:px-0 px-[20px]">
    <!-- wp:group -->
    <div class="wp-block-group title-wrapper relative desktop:mb-[200px] mb-[50px] desktop:flex gap-[20px]">
      <!-- wp:group -->
      ...
      <div class="wp-block-group realizations-title z-[1] relative">
        ...
        <div class="wp-block-group overflow-hidden">
          <!-- wp:paragraph -->
          <p data-aos="fade-up" data-aos-duration="600" data-aos-offset="30" class="uppercase desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">Zobacz efekty</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
