  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px] desktop:mt-0 mt-[120px] desktop:p-[110px] h-[300px] desktop:h-[700px] wide:h-[940px] ">
    ...
    <div class="wp-block-group title-wrapper relative desktop:mb-[80px] mb-[60px]">
      ...
      <div class="wp-block-group overflow-hidden">
        <!-- wp:paragraph -->
        <p data-aos="fade-up" data-aos-duration="600" data-aos-offset="155" class="section-title text-[20px] text-primaryYellow">Wymagaj więcej</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
      ...
      <div class="wp-block-group font-normal desktop:text-[65px] text-[32px] desktop:leading-[70px] leading-[36px] relative z-[1]">
        ...
        <div class="wp-block-group overflow-hidden">
          <!-- wp:paragraph -->
          <p data-aos="fade-up" data-aos-duration="600" data-aos-offset="155" class="uppercase">Porozmawiajmy</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
        <!-- wp:group -->
        <div class="wp-block-group overflow-hidden">
          <!-- wp:paragraph -->
          <p data-aos="fade-up" data-aos-duration="600" data-aos-offset="130" class="uppercase">o potrzebach</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
        <!-- wp:group -->
