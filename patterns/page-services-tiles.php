  ...
  <div class="wp-block-group container mx-auto relative desktop:px-0 px-[20px]">
    ...
    <div class="wp-block-group title-wrapper relative container mx-auto desktop:mb-[120px] mb-[60px] desktop:flex z-[1]">
      ...
      <div class="wp-block-group h-fit overflow-hidden">
        <!-- wp:paragraph -->
        <p data-aos="fade-up" data-aos-duration="600" data-aos-offset="130" class="section-title block desktop:basis-auto desktop:w-[175px] pt-[4px] uppercase text-primaryYellow text-right pr-[20px]">qMarketing robimy kompleksowo</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
