  ...
  <div class="wp-block-group relative px-[20px] desktop:px-0">
    ...
    <div class="wp-block-group title-wrapper container mx-auto relative desktop:mb-[110px] mb-[80px] desktop:flex gap-[20px]">
      ...
      <div class="wp-block-group uslugi-title is-layout-flow">
        ...
        <div class="wp-block-group overflow-hidden">
          <!-- wp:heading -->
          <h2 class="inline"><span data-aos="fade-up" data-aos-duration="600" data-aos-offset="85" class="inline uppercase desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">Holistyczne podejście do działań reklamowych sprawia, że nasza firma działa
            </span></h2>
          <!-- /wp:heading -->

          <!-- wp:heading -->
          <h2 class="inline"><span data-aos="fade-up" data-aos-duration="600" data-aos-offset="85" class="relative ml-[12px] desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px] inline uppercase italic before:content-[''] before:inline-block desktop:before:mr-[18px] before:mr-[8px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-white">jak jeden organizm</span></h2>
          <!-- /wp:heading -->
        </div>
        <!-- /wp:group -->
      </div>
    ...
    <div class="wp-block-group targets-wrapper desktop:flex gap-x-[80px] wide:gap-x-[200px]">
      ...
      <div class="wp-block-group col1 desktop:mb-auto mb-[20px] desktop:basis-[45%] h-[450px] desktop:h-[790px] wide:h-[900px] rounded-tr-[15px]">
        ...
        <!-- wp:paragraph -->
        <p>
          <svg x="0px" y="0px" viewBox="0 0 1374.7 1083.6" class="absolute top-0 z-[-1]">
            <defs>
        ...
        <ul class="wp-block-list targets-list max-w-[600px] wide:mb-[100px] desktop:mb-[70px] mb-[40px] text-left desktop:flex flex-wrap desktop:justify-start justify-center gap-x-[30px] gap-y-[50px]">
          ...
          <li class="relative mb-[20px] desktop:mb-0 desktop:max-w-[264px] max-w-full flex items-center desktop:list-item gap-[20px]">
            ...
            <div class="wp-block-group counter-index-wrapper min-w-[95px] inline relative">
              ...
              <!-- wp:paragraph -->
              <span data-aos="fade-right" data-aos-duration="600" data-aos-offset="85" class="target-num inline-block desktop:text-[85px] text-[80px] font-semibold">01</span>
              <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
          ...
          <li class="relative mb-[20px] desktop:mb-0 desktop:max-w-[264px] max-w-full flex items-center desktop:list-item gap-[20px]">
            ...
            <div class="wp-block-group counter-index-wrapper min-w-[95px] inline relative">
              ...
              <!-- wp:paragraph -->
              <span data-aos="fade-right" data-aos-duration="600" data-aos-offset="85" class="target-num inline-block desktop:text-[85px] text-[80px] font-semibold">02</span>
              <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
