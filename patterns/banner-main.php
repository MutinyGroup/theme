  ...
  <div class="wp-block-group container mx-auto desktop:px-0 px-[20px] wide:h-[900px] desktop:h-[790px] h-fit">
    ...
    <div class="wp-block-group content-with-bg-wrapper">
      ...
      <div class="wp-block-group right-col banner-bg h-[300px] desktop:h-auto wide:h-[950px] desktop:w-[44%] w-[65%] absolute right-0 desktop:top-[50px] top-[30px] z-[-1]">
        <!-- wp:image -->
        <figure class="wp-block-image clipped-banner max-h-[300px] relative desktop:max-h-full before:content-[''] before:w-full before:h-full before:bg-[#000] before:opacity-[30%] before:absolute before:top-0 before:left-0">
          <img
