            ...
            while($post_query->have_posts() ) {
              ...
              if (true){ ?>         
                ...
                <li class="wp-block-group swiper-slide img-clip-path-rounded relative group desktop:w-[545px] w-[100%] desktop:h-[600px] h-[320px] <?php if (($counter % 2)) echo ''; else echo 'desktop:translate-y-[50px]'; ?>">                
                  <!-- wp:group -->
                  <div
                    class="wp-block-group group relative gallery-tile w-full <?php if($counter == 1) echo 'clipped-realizations-1 tile-services-1'; elseif($counter == $post_query->post_count) echo 'clipped-realizations-2 tile-services-2'; ?>  z-[1] group desktop:p-[25px] desktop:h-[600px] h-[320px] overflow-hidden rounded-[20px] transition ease-out duration-300 mr-[8px] mb-[30px]"
                  >
                    <!-- wp:group -->
                    <div
                    ...
                    >
                      ...
                      <!-- wp:image -->
                      <figure
                        class="wp-block-image h-full group-hover:grayscale transition ease-in-out duration-[400ms] <?php if($counter == 1) echo 'clipped-realizations-1'; elseif($counter == $post_query->post_count) echo 'clipped-realizations-2'; ?>"
                      >
                        <img
                    ...
                    <!-- wp:group -->
                    <div
                      class="wp-block-group slide-title absolute desktop:bottom-[0px] bottom-[55px] desktop:left-[25px] left-[20px] translate-y-[130px] desktop:translate-y-[-40px] group-hover:translate-y-[-20px] desktop:group-hover:translate-y-[-140px] transition ease-out duration-[400ms]"
                    >
                      <!-- wp:paragraph -->
                  ...
                  <!-- wp:buttons -->
                  <div
                    class="wp-block-buttons btn-swiper-more group z-[2] pr-[20px] desktop:pr-0 text-[14px] font-semibold uppercase absolute  desktop:bottom-[75px] bottom-[20px] desktop:left-[25px] left-[20px] transition ease-out duration-300"
                  >
                    <!-- wp:paragraph -->
                    <a href="<?php the_permalink(); ?>" class="flex items-center desktop:block">
                      <!-- wp:group -->
