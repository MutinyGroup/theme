  ...
  <div class="wp-block-group relative ">
    ...
    <div class="wp-block-group title-wrapper relative container mx-auto desktop:px-0 px-[20px] desktop:mb-[0px] mb-[40px] flex gap-[20px]">
      ...
      <div class="wp-block-group uslugi-title desktop:leading-[55px] leading-[30px]">
        ...
        <!-- /wp:paragraph -->
        <!-- wp:paragraph -->
        <p class="relative desktop:text-[50px] text-[26px] uppercase italic before:content-[''] before:inline-block desktop:before:mr-[18px] before:mr-[5px] before:bottom-0 before:left-0 desktop:before:w-[120px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-white">z Mutiny Group</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
    </div>
    ...
    <div class="wp-block-group relative min-h-[855px]">
      ...
      <div class="wp-block-group desktop:mt-[-120px] w-full overflow-hidden">
        ...
        <div id="blog" class="wp-block-group swiper swiperBlog desktop:w-[calc(100%-90px)] desktop:pt-[180px] absolute top-0 desktop:top-[30px] desktop:left-[90px] left-[20px]">
          ...
          <!-- wp:group -->
          <div id="blog-prev" class="wp-block-group group swiper-button-prev desktop:inline-block hidden w-[56px] h-[56px] absolute desktop:top-[90px] top-[35px] desktop:right-[50px]">
            <!-- wp:paragraph -->
          ...
          <!-- /wp:group -->
          <!-- wp:group -->
          <div id="blog-next" class="wp-block-group group swiper-button-next desktop:inline-block hidden w-[56px] h-[56px] absolute desktop:top-[90px] top-[35px] desktop:right-[10px]">
            <!-- wp:paragraph -->
