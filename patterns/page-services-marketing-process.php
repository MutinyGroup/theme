        ...
        <div class="wp-block-group cols-wrapper desktop:flex gap-[75px]">
          ...
          <div class=" wp-block-group col1 desktop:w-[50%]">
            ...
            <div class="wp-block-group mb-[20px] h-auto desktop:h-[640px]">
              ...
              <!-- wp:paragraph -->
              <p>
                <svg x="0px" y="0px" viewBox="0 0 1374.7 1083.6" class="absolute top-0 h-[50px] w-[50px]">
                  <defs>
          ...
          <div class="wp-block-group col2 desktop:w-[50%] z-[1]">
            ...
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
            <p class="text-[16px] pt-[50px]"><span data-aos="fade-right" data-aos-duration="600" data-aos-offset="85" class="block">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.</span></p>
            <!-- /wp:paragraph -->
