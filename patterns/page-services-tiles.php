...
<div id="Kafelki" class="wp-block-group page-about-services desktop:mt-[150px] pt-[80px] desktop:pt-[80px]">
  ...
  <div class="wp-block-group container mx-auto relative desktop:px-0 px-[20px]">
    ...
    <div class="wp-block-group title-wrapper relative container mx-auto desktop:mb-[100px] mb-[60px] desktop:flex z-[1]">
      ...
      <!-- wp:heading -->
      <h2 class="wp-block-heading uslugi-title desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]"><span class="block overflow-hidden"><span data-aos="fade-up" data-aos-duration="600" data-aos-offset="30" class="block company-title overflow-hidden"><span class="block uppercase">Wybierz usługę którą</span></span></span><span class="block overflow-hidden"><span data-aos="fade-up" data-aos-duration="600" data-aos-offset="30" class="uppercase test01 inline-block ">JESTEŚ<span class="relative ml-[12px] inline-block uppercase italic before:content-[''] before:inline-block desktop:before:mr-[18px] before:mr-[8px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-black">ZAINTERESOWANY</span></span></span></h2>
      <!-- /wp:heading -->
    </div>
    <!-- /wp:group -->
      ...
      <div class="wp-block-group above-post-template-services ul-wrapper mx-auto w-[100%] wide:max-w-[1100px]">
        ...
        <div class="wp-block-group swiper-slide servicesTile relative group desktop:w-[530px] w-[100%] desktop:h-[600px] h-[320px] transition duration-[800ms] ease-in">
          ...
          <div class="wp-block-group h-full w-full">
            <!-- wp:group -->
            <div class="wp-block-group group relative gallery-tile before:pointer-events-none w-full before:content-[''] before:opacity-100 before:absolute before:top-0 before:left-0 before:z-[0] before:w-full before:h-full before:bg-cover before:transition before:duration-[300ms] before:ease-out tile-services-1 z-[1] group desktop:p-[25px] desktop:h-[600px] h-[320px] overflow-hidden rounded-[20px] transition ease-out duration-300 mr-[8px] mb-[30px]">
              <!-- wp:group -->
                ...
                <p class="pointer-events-none">
                  <svg x="0px" y="0px" viewBox="0 0 1374.7 1083.6" class="absolute top-0">
                    <defs>
                      ...
                      if (true) {
                        echo '
                          <clipPath id="clipped-realizations-1" class="z-[-1] scale-[0.002]" clipPathUnits="objectBoundingBox">
                ...
                <p class="pointer-events-none">
                  <svg x="0px" y="0px" viewBox="0 0 1374.7 1083.6" class="absolute top-0">
                    <defs>
                      ...
                      if (true) {
                        echo '
                          <clipPath id="clipped-realizations-2" class="z-[-1] scale-[0.00143] scale-x-[0.00188]" clipPathUnits="objectBoundingBox">
            ...
            <!-- wp:paragraph -->
            <p class="btn-swiper-more group z-[2] pr-[20px] desktop:pr-0 text-[14px] font-semibold uppercase absolute pointer-events-none desktop:bottom-[75px] bottom-[20px] desktop:left-[25px] left-[20px] transition ease-out duration-300">
