      ...
      <div class="wp-block-group col2 relative  desktop:basis-[55%]">
        ...
        <div class="wp-block-group button-wrapper flex justify-center items-center gap-[64px]">
          ...
          <div class="wp-block-buttons">
            ...
            <!-- wp:paragraph -->
            <p><a href="<?php echo get_home_url() . '/about'; ?>" class="uppercase group bg-black text-white text-[14px] font-bold min-w-[225px] flex justify-center items-center px-[20px] btn-more ml-[0px] p-[15px_30px] border-[2px] border-black rounded-full  transition ease-out duration-300 overflow-hidden">
                <!-- wp:group -->
                <div class="wp-block-group overflow-hidden h-[15px]">
                  <!-- wp:group -->
                  <div class="wp-block-group translate-y-0 gro">
                    <!-- wp:paragraph -->
                    <p class=" translate-y-0 group-hover:translate-y-[100px] transition ease-out duration-300 overflow-hidden">
                      Dowiedz się więcej
                    </p>
                    <!-- /wp:paragraph -->
                    <!-- wp:paragraph -->
