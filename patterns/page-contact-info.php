...
<div id="Info" class="wp-block-group page-contact-info my-[150px]">
  ...
  >
    ...
    <!-- wp:group -->
    <div class="wp-block-group paragrapth-wrapper relative mb-[100px] flex justify-end">
      <!-- wp:paragraph -->
    ...
    <div class="wp-block-group contact-info-cols-wrapper desktop:flex desktop:gap-[80px] gap-[20px]">
      ...
      <div class="wp-block-group col1 desktop:w-[35%]">
        ...
        >
          ...
          <svg x="0px" y="0px" viewBox="0 0 1374.7 1083.6" class="absolute top-0" >
            <defs>
              <clipPath id="clipped-blog" class="scale-[0.0021] scale-x-[0.00282] desktop:scale-y-[0.0022] desktop:scale-[0.0028] wide:scale-y-[0.0021]" clipPathUnits="objectBoundingBox">
      ...
      <div class="wp-block-group col2 self-center text-wrapper">
        ...
        <div class="wp-block-group mail-phone-wrapper flex flex-col gap-y-[14px] desktop:leading-[38px] leading-[24px]">
          ...
          <!-- /wp:paragraph -->
          <!-- wp:paragraph -->
          <p class="w-fit desktop:text-[20px] text-[15px] leading-[24px] inline font-medium border-b-[1px] border-black hover:border-primaryYellow hover:text-primaryYellow transition ease-out duration-300 cursor-pointer">+48 795 123 584</p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
