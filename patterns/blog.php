  ...
  <div class="wp-block-group relative ">
    ...
    <div class="wp-block-group title-wrapper relative container mx-auto desktop:px-0 px-[20px] desktop:mb-[0px] mb-[40px] desktop:flex gap-[20px]">
      ...
      <div class="wp-block-group h-fit overflow-hidden">
        <!-- wp:paragraph -->
        <p data-aos="fade-up" data-aos-duration="600" data-aos-offset="130" class="section-title uppercase text-primaryYellow">Aktualności2</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
          ...
          <div class="wp-block-group swiper-wrapper">
            ...
            if ($post_query->have_posts()) {
              while ($post_query->have_posts()) {
                ...
                if ($counter == 1) { ?>
                  <!-- wp:paragraph -->
                  <a href="<?php the_permalink(); ?>" data-aos="fade-left" data-aos-duration="600" data-aos-offset="130" class="swiper-slide desktop:w-[535px] w-[300px] h-[500px] desktop:h-[675px]">
                    <!-- wp:group -->
                ...
                <?php
                  ...
                  <!-- wp:paragraph -->
                  <a href="<?php the_permalink(); ?>" data-aos="fade-left" data-aos-duration="600" data-aos-offset="130" class="swiper-slide mr-[25px] desktop:w-[444px] w-[280px] desktop:h-[675px] h-[480px]">
                    <!-- wp:group -->
                    <div class="wp-block-group h-full w-full">
                      <!-- wp:group -->
                      <div class="wp-block-group">
    ...
    <div class="wp-block-group button-wrapper container mx-auto px-[20px] desktop:px-0 flex items-center justify-center desktop:gap-[80px] gap-[20px] cursor-pointer">
      ...
      <ul class="wp-block-list min-w-fit">
        ...
        <li class="wp-block-group">
          <a href="<?php echo get_home_url() . '/blog'; ?>" class="uppercase group bg-black text-white text-[14px] font-bold min-w-fit flex justify-center items-center px-[20px] btn-more ml-[0px] p-[15px_30px] border-[2px] rounded-full hover:bg-white hover:text-black">
            <!-- wp:group -->
