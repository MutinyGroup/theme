        ...
        <div id="uslugi" class="wp-block-group swiper swiperServices above-post-template-frontpage-services w-screen desktop:w-[calc(100%-90px)] desktop:pt-[180px] absolute top-[400px] desktop:top-[160px] left-[20px] desktop:left-[90px]">
          ...
          <div class="wp-block-group swiper-slide swiper-slide-services group relative z-[2] wide:max-w-[420px] desktop:min-w-[354px] max-w-[310px] h-[380px] desktop:h-[450px] wide:h-[530px] rounded-[20px] text-[18px] flex items-center before:hover:opacity-100 after:hover:opacity-100 wide:before:h-[530px] wide:after:h-[530px] transition ease-out duration-300 before:content-[''] before:opacity-0 before:absolute before:top-0 before:left-0 before:z-[2] before:w-full before:h-[450px] before:bg-gradient-to-t before:from-black before:via-[rgba(0,0,0,0)] before:bg-center before:bg-cover before:transition before:duration-[300ms] before:ease-out before:grayscale after:content-[''] after:opacity-0 after:absolute after:top-0 after:left-0 after:z-[-1] after:w-[354px] after:h-[450px] after:transition after:duration-[300ms] after:ease-out after:grayscale cursor-default">
            ...
            <div class="wp-block-group block w-full h-full ">
              ...
              <!-- wp:group -->
              <div class="wp-block-group px-[25px] hover-text mt-[370px] wide:mt-[350px] max-h-[45pv] overflow-y-hidden opacity-[0%] group-hover:opacity-[100%] group-hover:mt-[120px] desktop:group-hover:mt-[330px] wide:group-hover:mt-[270px] transition-all ease-out duration-500 text-[15px] font-light z-[2] relative">
    ...
    <div class="wp-block-group button-wrapper container mx-auto mt-[50px] wide:mt-[120px] flex items-center justify-center gap-[64px]">
      ...
      <div class="wp-block-group uppercase btn-text-roll group bg-darkBlack text-white text-[14px] font-bold min-w-[225px] flex justify-center items-center px-[20px] btn-more ml-[0px] p-[15px_30px] border-[2px] rounded-full hover:bg-white hover:text-black">
        ...
        <div class="wp-block-group overflow-hidden h-[18px]">
          <!-- wp:paragraph -->
          <p>
            <a href="<?php echo get_home_url() . '/services'; ?>" class="inline-block">Dowiedz się więcej</a>
          </p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
