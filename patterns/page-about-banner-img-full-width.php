    ...
    <div class="wp-block-group title-wrapper relative desktop:mb-[40px] mb-[20px] desktop:mt-[90px]">
      ...
      <div class="wp-block-group relative container mx-auto desktop:flex">
        ...
        <div class="wp-block-group max-w-[75%] uslugi-title uppercase font-medium desktop:text-[60px] text-[30px] desktop:leading-[66px] leading-[30px]">
          ...
          <div class="wp-block-group overflow-hidden">
            <!-- wp:paragraph -->
            <p class="uppercase test01 inline-block ">PRZEKRACZAĆ<span class="relative ml-[12px] inline-block uppercase italic before:content-[''] before:inline-block desktop:before:mr-[18px] before:mr-[8px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-black">GANIC</span></p>
            <!-- /wp:paragraph -->
            <!-- wp:paragraph -->
