  ...
  <div class="wp-block-group desktop:mb-[150px] mb-[80px] pt-[100px] desktop:pt-0 relative overflow-hidden desktop:overflow-visible">
    ...
    <div class="wp-block-group title-wrapper relative container mx-auto desktop:px-0 px-[20px] desktop:mb-[80px] mb-[50px] desktop:mt-0 desktop:flex gap-[20px]">
      ...
      <div class="wp-block-group uslugi-title z-[1]">
        <!-- wp:heading -->
        <h2><span class="wp-block-group block overflow-hidden"><span class="uppercase inline-block desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]"><span class="block" data-aos="fade-up" data-aos-duration="600" data-aos-offset="30"> KAMPANIE REALIZUJEMY</span></span></span><span class="wp-block-group block overflow-hidden"><span class="relative ml-[12px] desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px] inline-block uppercase italic "><span data-aos="fade-up" data-aos-duration="600" data-aos-offset="30" class="block before:content-[''] before:inline-block desktop:before:mr-[18px] before:mr-[8px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-white">KOMPLEKSOWO</span></span></span></h2>
        <!-- /wp:heading -->
      </div>
      <!-- /wp:group -->
    </div>
    ...
    <!-- wp:group -->
    <div class="wp-block-group mx-[0px] desktop:ml-[360px] desktop:mb-[0px] mb-[40px] desktop:px-0 px-[20px] max-w-full desktop:max-w-[400px] desktop:leading-[30px] leading-[26px] desktop:text-[20px] text-[15px] font-light relative z-[2]">
      <!-- wp:paragraph -->
    ...
    <div class="wp-block-group mt-[80px] desktop:mt-[-120px] w-full h-[380px] desktop:h-[660px] wide:h-[720px] overflow-hidden swiper-services-editor">
      ...
      <div class="wp-block-group swiper-overscroll above-wp-query">
        ...
        <!-- wp:group -->
        <div id="uslugi" class="wp-block-group swiper swiperServices above-post-template-frontpage-services w-screen desktop:w-[calc(100%-90px)] desktop:pt-[180px] absolute top-[400px] desktop:top-[160px] left-[20px] desktop:left-[90px]">
          <!-- wp:post-template {"className":"swiper-wrapper"} -->

          <!-- wp:group -->
          <div class="wp-block-group swiper-slide swiper-slide-services group relative z-[2] wide:max-w-[420px] desktop:min-w-[354px] w-[310px] h-[380px] desktop:h-[450px] wide:h-[530px] rounded-[20px] text-[18px] flex items-center before:hover:opacity-100 after:hover:opacity-100 wide:before:h-[530px] wide:after:h-[530px] transition ease-out duration-300 before:content-[''] before:pointer-events-none before:opacity-0 before:absolute before:top-0 before:left-0 before:z-[2] before:w-full before:h-[450px] before:bg-gradient-to-t before:from-black before:via-[rgba(0,0,0,0)] before:bg-center before:bg-cover before:transition before:duration-[300ms] before:ease-out before:grayscale after:pointer-events-none after:content-[''] after:opacity-0 after:absolute after:top-0 after:left-0 after:z-[-1] after:w-[354px] after:h-[450px] after:transition after:duration-[300ms] after:ease-out after:grayscale cursor-default">
            <!-- wp:group -->
            <div class="wp-block-group hiver block w-full h-full ">
              <!-- wp:group -->
              <div class="wp-block-group img-clip-path-wrapper w-full h-full rounded-[20px] rounded-br-[20px] overflow-hidden absolute left-0 top-0 z-[1] group-hover:grayscale">
                ...
                <div class="wp-block-group img-clip-path-wrapper w-full h-full rounded-[20px] rounded-br-[20px] overflow-hidden absolute left-0 top-0 z-[1] group-hover:grayscale">
                  ...
                  <!-- /wp:group -->
                  <!-- wp:group -->
                  <div class="wp-block-group services-img   h-full">
              ...
              <!-- wp:buttons -->
              <div class="wp-block-buttons btn-swiper-more  text-[14px] uppercase absolute desktop:bottom-[25px] bottom-[55px] left-[25px] cursor-pointer pointer-events-none transition ease-out duration-300 z-[3]">
    ...
    <div class="wp-block-group button-wrapper container mx-auto mt-[50px] wide:mt-[120px] flex items-center justify-center gap-[64px]">
      ...
      <div class="wp-block-group uppercase btn-text-roll group bg-darkBlack text-white text-[14px] font-bold min-w-[225px] flex justify-center items-center px-[20px] btn-more ml-[0px] p-[15px_30px] border-[2px] rounded-full hover:bg-white hover:text-black">
        ...
        <div class="wp-block-group overflow-hidden h-[18px]">
          <!-- wp:paragraph -->
          <p><a href="<?php echo get_home_url() . '/services'; ?>" class="inline-block">Dowiedz się więcej</a></p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
      </div>
