    ...
    <div class="wp-block-group title-wrapper relative container mx-auto desktop:px-0 px-[20px] desktop:mb-[80px] mb-[50px] desktop:mt-0 desktop:flex gap-[20px]">
      ...
      <div class="wp-block-group uslugi-title z-[1]">
        ...
        <div class="wp-block-group overflow-hidden">
          <!-- wp:paragraph -->
          <h2 class="uppercase inline-block desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]"><span data-aos="fade-up" data-aos-duration="600" data-aos-offset="30"> KAMPANIE REALIZUJEMY</span></h2>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
        <!-- wp:group -->
