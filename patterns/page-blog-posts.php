    ...
    <div class="wp-block-group new gallery-cols relative flex justify-between desktop:pb-[150px] pb-[80px]">
      ...
      <div class="wp-block-group above-wp-query">
        ...
        <div class="wp-block-group above-post-template-realizacje ul-wrapper-realizacje mx-auto w-[100%]">
          ...
          <!-- wp:group -->
          <div class="wp-block-group bigger relative group swiper-slide  w-full slideBlog opacity-0 desktop:w-[535px] wide:w-[580px] h-fit desktop:h-[545px] wide:h-[650px] transition duration-[800ms] ease-in">
            <!-- wp:group -->
            <div class="wp-block-group">
              ...
              <div class="wp-block-group h-[330px] desktop:h-full mb-[20px]">
                ...
                <div class="wp-block-group h-full overflow-hidden rounded-[20px]">
                  <!-- wp:group -->
                  <div class="wp-block-group h-full post-img clip-path-url-['#clipped-blog']">
