      ...
      <ul class="wp-block-list w-[100%] wide:max-w-[1115px] mx-auto flex flex-wrap justify-between gap-x-[8px] gap-y-[30px]">
        ...
        if ($post_query->have_posts()) {
          ...
          while ($post_query->have_posts()) {
            ...
            if (true) { ?>
              <!-- wp:list-item -->
              <li class="wp-block-group swiper-slide servicesTile opacity-0 relative group desktop:w-[545px] w-[100%] desktop:h-[600px] h-[320px] transition duration-[300ms] ease-out <?php echo (($counter % 2)) ? "" : 'desktop:translate-y-[50px]'; ?>">
                <!-- wp:group -->
