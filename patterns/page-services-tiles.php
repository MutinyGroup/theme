  ...
  <div class="wp-block-group container mx-auto relative desktop:px-0 px-[20px]">
    ...
    <div class="wp-block-group title-wrapper relative container mx-auto desktop:mb-[120px] mb-[60px] desktop:flex z-[1]">
      ...
      <div class="wp-block-group h-fit overflow-hidden">
        <!-- wp:paragraph -->
        <p data-aos="fade-up" data-aos-duration="600" data-aos-offset="130" class="section-title desktop:basis-auto desktop:w-[145px] uppercase text-primaryYellow text-right pr-[20px]">Marketing robimy kompleksowo</p>
        <!-- /wp:paragraph -->
      </div>
      <!-- /wp:group -->
      ...
      <div class="wp-block-group uslugi-title">
        ...
        <div class="wp-block-group overflow-hidden">
          ...
          <!-- wp:paragraph -->
          <p data-aos="fade-up" data-aos-duration="600" data-aos-offset="130" class="uppercase desktop:text-[50px] text-[24px] desktop:leading-[55px] leading-[30px]">Wybierz usługę którąŁ <br />jesteś<span data-aos="fade-up" data-aos-duration="600" data-aos-offset="130" class="relative desktop:text-[50px] text-[24px] uppercase italic before:content-[''] before:inline-block desktop:before:mr-[8px] before:mr-[4px] before:bottom-0 before:left-0 desktop:before:w-[90px] before:w-[30px] desktop:before:h-[3px] before:h-[2px] before:bg-black">zainteresowany</span></p>
          <!-- /wp:paragraph -->
        </div>
        <!-- /wp:group -->
